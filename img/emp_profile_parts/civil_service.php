 ...
 <div class="form-row mt-5">
     ...
     <div class="col-lg-5 col-sm-12">
         <div class="d-flex flex-column">
            <small class="text-muted">Name of Examination</small>
     ...
     <div class="col-lg-3 col-sm-6">
         <div class="d-flex flex-column">
         <small class="text-muted">Examination Date</small>
     ...
     <div class="col-lg-2 col-sm-6">
         <div class="d-flex flex-column">
             <small class="text-muted">Rating <span class="test-muted"> (if applicable) </span></small>
     ...
     <div class="col-lg-4 col-sm-12">
         ...
         <div class="col-lg-3 col-sm-6">
             ...
             <small class="text-muted">License (if applicable)</small>
...
<?php  }else { ?>
 ...
 <div class="col-lg-2 col-sm-6">
     <div class="d-flex flex-column">
         <small class="text-muted">Rating <span class="test-muted"> (if applicable) </span></small>
         <lab      <input type="text" class="form-control text-input" name="civil_exam_rating[]">
     </div>
 </div>
 ...
 <script type="text/javascript">
     $(document).ready(function () {
         ...
         var fieldHTML =
             ' <div class="form-row mt-5"> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <label for="">TYPE</label> <select class="form-control text-input"  name="civil_exam_type[]"> <option value="">SELECT</option> <option value="Board Examination">Board Examination</option> <option value="Civil Service Examination">Civil Service Examination</option> <option value="Others">Others</option> </select> </div> </div> <div class="col-lg-5 col-sm-12"> <div class="d-flex flex-column"> <label for="">NAME OF EXAMINATION</label> <input type="text" class="form-control text-input" name="civil_exam_name[]"> </div> </div> <div<small class="text-muted">Examination Date</small> <input type="date" class="form-control text-input" name="civil_exam_date[]"> </div> </div> </div> <div <small class="text-muted">Rating <span class="test-muted"> (if applicable) </span></small>class="form-ro          <label for="">RATING <span class="text-muted"> (if applicable) </span></label> <input type="text" class="form-control text-input" name="civil_exam_rating[]"> </div> </div> <div class="col-lg-4 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Place of Examination</small> <input type="text" class="form-control text-input" name="civil_exam_place[]" > </div> </div> <div class="col-lg-3 col-sm-6"> <small class="text-muted">Year GrLicense (if applicable)>
              <input type="text" class="form-control text-input" name="civil_exam_licence_no[]" > </div> <!-- <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <label for="">NUMBER</label> <input type="text" class="form-control text-input" name="licence_no[]" > </div> </div> --> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Validity</small> <input type="date" class="form-control text-input" name="civil_exam_licence_val[]"> </div> </div> </div>';
