...
?>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="d-flex flex-column">
                        <small class<small class="text-muted">Name of School</small>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="d-flex flex-column">
                        <small class<small class="text-muted">Basic Education</small>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="d-flex flex-column">
                        <small class<small class="text-muted">Period of Attendance</small>
            ...
            <div class="form-row mt-3">
                <div class="col-lg-3 col-sm-12 ">
                    <small class<small class="text-muted">Highest Units Earned</small>
                ...
                <div class="col-lg-3 col-sm-12">
                    <small class<small class="text-muted">Year Graduated</small>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="d-flex flex-column">
                        <small class="text-muted">Name of School</small>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="d-flex flex-column">
                        <small class="text-muted">Basic Education</small>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="d-flex flex-column">
                        <small class="text-muted">Period of Attendance</small>
                        <div class="d-md-flex justify-content-center">
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-lg-3 col-sm-12">
                    <small class="text-muted">Highest Units Earned</small>
    ...
    $(document).ready(function() {
        ...
        $('.add_coll_button').click(function() {
            if (x < maxField) {
                ...
                $('.coll_wrapper').append('<div><div class="form-row mt-5"> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Name of School</small> <input type="text" class="form-control text-input" value="" name="coll_school_name[]"> </div> </div> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Basic Education</small> <input type="text" class="form-control text-input" value="" name="coll_degree[]"> </div> </div> <div class="col-lg-6 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Period of Attendance</small> <div class="d-md-flex justify-content-center"> <input type="date" class="form-control text-input mx-sm-1" value="" name="coll_from_date[]"> <input type="date" class="form-control text-input mx-sm-1" value="" name="coll_to_date[]"> </div> </div> </div> </div> <div class="form-row mt-3"> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Highest Units Earned</small> <input type="text" class="form-control text-input" value="" name="coll_units[]"> </div> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Scholarship/Awards</small> <input type="text" class="form-control text-input" value="" name="coll_award[]"> </div> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Year Graduated</small> <input type="text" class="form-control text-input" value="" name="coll_graduation[]"> </div>  </div> <a class="mt-3 btn button-1 remove_coll_button" style="height: fit-content;">-</a></div>');
        ...
        $('.add_gra_button').click(function() {
            if (y < maxField) {
                ...
                $('.gra_wrapper').append('<div><div class="form-row mt-5"> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Name of School</small> <input type="text" class="form-control text-input" value="" name="gra_school_name[]"> </div> </div> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Basic Education</small> <input type="text" class="form-control text-input" value="" name="gra_degree[]"> </div> </div> <div class="col-lg-6 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Period of Attendance</small> <div class="d-md-flex justify-content-center"> <input type="date" class="form-control text-input mx-sm-1" value="" name="gra_from_date[]"> <input type="date" class="form-control text-input mx-sm-1" value="" name="gra_to_date[]"> </div> </div> </div> </div> <div class="form-row mt-3"> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Highest Units Earned</small> <input type="text" class="form-control text-input" value="" name="gra_units[]"> </div> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Scholarship/Awards</small> <input type="text" class="form-control text-input" value="" name="gra_award[]"> </div> <div class="col-lg-3 col-sm-12"> <small class="text-muted">Year Graduated</small> <input type="text" class="form-control text-input" value="" name="gra_graduation[]"> </div> </div> <a class="mt-3 btn button-1 remove_gra_button" style="height: fit-content;">-</a></div>');
