    ...
    <div class="form-row mt-5">
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="d-flex flex-column">
                <small class="text-muted">Name of Organization</small>
        ...
        <div class="col-lg-3 col-sm-6">
            <small class="text-muted">No of Hours</small>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input type="date" class="form-control text-input mx-sm-1" name="vol_to_date[]" value="<?php echo $mydata['vol_to_date']?>">
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <input type="date" class="form-control text-input mx-sm-1" name="vol_from_date[]">

                    <input type="date" class="form-control text-input mx-sm-1" name="vol_to_date[]">
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var fieldHTML =
            ' <div class="form-row mt-5"> <div class="col-lg-4 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Name of Organization</small> <input type="text" class="form-control text-input"  name="vol_name_org[]"> </div> </div> <div class="col-lg-4 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Address</small> <input type="text" class="form-control text-input"  name="vol_org_add[]"> </div> </div> <div class="col-lg-3 col-sm-6"> <small class="text-muted">No of Hours</small> <input type="text" class="form-control text-input"  name="vol_no_of_hrs[]"> </div> </div> <div class="form-row mt-3"> <div class="col-lg-6 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Inclusive Dates</small> <div class="d-md-flex justify-content-center"> <input type="date" class="form-control text-input mx-sm-1" name="vol_from_date[]"> <input type="date" class="form-control text-input mx-sm-1" name="vol_to_date[]"> </div> </div> </div> <div class="col-lg-3 col-sm-6"> <small class="text-muted">Position/Role</small> <input type="text" class="form-control text-input"  name="vol_position[]"> </div> </div>';
