   ...
   while($mydata = $runquery -> fetch_assoc()){  ?>
    ...
    <div class="form-row mt-5">
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                <small class="text-muted">Inclusive Dates</small>
    ...
    <div class="form-row mt-3">
        ...
        <div class="col-lg-3 col-sm-12">
            <div class="d-flex flex-column">
                <small class="text-muted">Government Service</small>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var fieldHTML =
            '  <div class="form-row mt-5"> <div class="col-lg-6 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Inclusive Dates</small> <div class="d-md-flex justify-content-center"> <input type="date" class="form-control text-input mx-sm-1"  name="work_from_date[]"> <input type="date" class="form-control text-input mx-sm-1"  name="work_to_date[]"> </div> </div> </div> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Position/Title</small> <input type="text" class="form-control text-input"  name="work_position[]"> </div> </div> <div class="col-lg-3 col-sm-6"> <div class="d-flex flex-column"> <small class="text-muted">Employer</small> <input type="text" class="form-control text-input"  name="work_employer[]"> </div> </div> </div> <div class="form-row mt-3"> <div class="col-lg-3 col-sm-12"> <div class="d-flex flex-column"> <small class="text-muted">Government Service</small> <div class="d-flex justify-content-center" > <select name=" work_govt_service[]"  class="form-control text-input" > <option value="">Select</option> <option value="Yes">Yes</option> <option value="No">No</option> </select> </div> </div> </div> <div class="col-lg-2 col-sm-6"> <small class="text-muted">Monthly Salary</small> <input type="text" class="form-control text-input"  name=" work_monthly_sal[]"> </div> <div class="col-lg-2 col-sm-6"> <small class="text-muted">Increment</small> <input type="text" class="form-control text-input" name=" work_increment[]"> </div> <div class="col-lg-3 col-sm-6"> <small class="text-muted">Status</small> <select class="form-control text-input"  name="work_status[]"> <option value=0>Select</option> <option value="permanent">Permanent</option> <option value="contractual">Contractual</option> <option value="Job order">Job order</option> </select> </div> </div>';
