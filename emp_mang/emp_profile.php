                        ...
                        <div class="emp-profile-box-1 " <?php if ($_SESSION['user_role'] != 'Super Administrator') { ?> style="background: linear-gradient(rgba(91, 103, 76, 0.8), rgba(91, 103, 76, 0.8)) , url('<?php echo $banner ?>') repeat 0 0;" <?php } ?>>
                              <div class="row">
                                    ...
                                    <div class="d-flex flex-column <?php echo ($_SESSION['user_role'] == 'Super Administrator' ? 'col-lg-9 col-sm-12' : 'col-lg-12 col-sm-12') ?>" <?php echo ($_SESSION['user_role'] == 'Super Administrator' ? '' : 'style="height:250px') ?> ">
                                          ...
                                          <a href="#emp_agency" class="emp_profile_button emp_profile_button_active" id="agency" onClick="changeDiv('emp_agency')">Agency Profile | </a>

                                          <a href="#emp_pds" class="emp_profile_button" id="pds" onClick="changeDiv('emp_pds')" >PDS | </a>

                                          <a href="#emp_leave" class="emp_profile_button" id="leave" onClick="changeDiv('emp_leave')" >Leave ledger | </a>

                                          <a href="#emp_file" class="emp_profile_button" id="file" onClick="changeDiv('emp_file')">File 201</a>
                                    </div>
...
<div class="agency-tab emp_profile_tab" style="display: block;" id="emp_agency">
      <?php include "agency.php"; ?>
</div>

<div class="leave-tab emp_profile_tab" id="emp_leave">
      <?php include "leave.php"; ?>
</div>

<div class="file-tab emp_profile_tab" id="emp_file">
      <?php include "file.php"; ?>
</div>

<div class="pds-tab emp_profile_tab" id="emp_pds">
      <?php include "pds.php"; ?>
</div>

<a  href="#"  onclick="location.reload()" class="btn button-2 mt-3">Refresh</a>
</div>
...
<script>
      ...
      function changeDiv(divname) {
            ...
            var targetBox = $('#' + divname);
            $(".emp_profile_tab").not(targetBox).hide();
            $(targetBox).show();
            var button_id = divname.split('_')[1];
            $('.emp_profile_button').removeClass('emp_profile_button_active');
                  $('#'+button_id).addClass('emp_profile_button_active');
