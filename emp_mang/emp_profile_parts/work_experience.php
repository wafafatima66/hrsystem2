        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    <input type="date" class="form-control text-input " name="work_from_date[]"
                        value="<?php echo $mydata['work_from_date']?>">
                    <input type="date" class="form-control text-input " name="work_to_date[]"
                        value="<?php echo $mydata['work_to_date']?>">
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="d-flex flex-column">
                ...
                <input type="text" class="form-control text-input" name="work_position[]"
                    value="<?php echo $mydata['work_position']?>">
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="d-flex flex-column">
                ...
                <input type="text" class="form-control text-input" name="work_employer[]"
                    value="<?php echo $mydata['work_employer']?>">
            </div>
        </div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex justify-content-center">
                    <select name="work_govt_service[]" class="form-control text-input">
                        ...
                        <option value="Y" <?php if ($mydata['work_govt_service'] == "Y"  ) {
