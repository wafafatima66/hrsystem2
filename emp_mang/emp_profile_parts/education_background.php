...
<div class="form-row mt-3">
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="d-flex flex-column">
            ...
            <input type="text" class="form-control text-input" value="<?php echo $mydata['ele_degree'] ?>"
                name="ele_degree">
        </div>
    </div>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="ele_from_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['ele_from_date']) ? "2021": $mydata['ele_from_date']  )?>"
                    class="form-control text-input mx-sm-1" />
                <input name="ele_to_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['ele_to_date']) ? "2021": $mydata['ele_to_date']  )?>"
                    class="form-control text-input mx-sm-1" />
            </div>
        </div>
    </div>
...
<div class="form-row mt-3">
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="d-flex flex-column">
            <label for="">BASIC EDUCATION</label>
            <input type="text" class="form-control text-input" value="<?php echo $mydata['sec_degree'] ?>"
                name="sec_degree">
        </div>
    </div>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="sec_from_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['sec_from_date']) ? "2021": $mydata['sec_from_date']  )?>"
                    class="form-control text-input mx-sm-1" />
                <input name="sec_to_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['sec_to_date']) ? "2021": $mydata['sec_to_date']  )?>"
                    class="form-control text-input mx-sm-1" />
...
<div class="form-row mt-3">
    ...
    <div class="col-lg-3 col-sm-12">
        <label for="">YEAR GRADUATED</label>
        <input type="text" class="form-control text-input" value="<?php echo $mydata['sec_graduation'] ?>"
            name="sec_graduation">
    </div>
...
<div class="form-row mt-3">
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="d-flex flex-column">
            <label for="">BASIC EDUCATION</label>
            <input type="text" class="form-control text-input" value="<?php echo $mydata['voc_degree'] ?>"
                name="voc_degree">
        </div>
    </div>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="voc_from_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['voc_from_date']) ? "2021": $mydata['voc_from_date']  )?>"
                    class="form-control text-input mx-sm-1" />
                <input name="voc_to_date" type="number" min="1900" max="2099" step="1"
                    value="<?php echo (empty($mydata['voc_to_date']) ? "2021": $mydata['voc_to_date']  )?>"
                    class="form-control text-input mx-sm-1" />
...
<div class="coll_wrapper">
    ...
    <div class="form-row mt-3">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="d-flex flex-column">
                <label for="">NAME OF SCHOOL</label>
                <input type="text" class="form-control text-input" value="<?php echo $mydata['school_name'] ?>"
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="d-flex flex-column">
                <label for="">BASIC EDUCATION</label>
                <input type="text" class="form-control text-input" value="<?php echo $mydata['degree'] ?>"
                    name="coll_degree[]">
            </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="coll_from_date[]" type="number" min="1900" max="2099" step="1"
                        value="<?php echo (empty($mydata['from_date']) ? "2021": $mydata['from_date']  )?>"
                        class="form-control text-input mx-sm-1" />
                    <input name="coll_to_date[]" type="number" min="1900" max="2099" step="1"
                        value="<?php echo (empty($mydata['to_date']) ? "2021": $mydata['to_date']  )?>"
                        class="form-control text-input mx-sm-1" />
    ...
    <div class="form-row mt-3 pb-5">
        ...
        <div class="col-lg-3 col-sm-12">
            <label for="">HIGHEST UNITS EARNED</label>
            <input type="text" class="form-control text-input" value="<?php echo $mydata['units'] ?>"
                name="coll_units[]">
        </div>

        <div class="col-lg-3 col-sm-12">
            <label for="">SCHOLARSHIP/AWARDS</label>
            <input type="text" class="form-control text-input" value="<?php echo $mydata['award'] ?>"
                name="coll_award[]">
        </div>

        <div class="col-lg-3 col-sm-12">
            <label for="">YEAR GRADUATED</label>
            <input type="text" class="form-control text-input" value="<?php echo $mydata['graduation'] ?>"
                name="coll_graduation[]">
        </div>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="coll_from_date[]" type="number" min="1900" max="2099" step="1" value=""
                        class="form-control text-input mx-sm-1" />
                    <input name="coll_to_date[]" type="number" min="1900" max="2099" step="1" value=""
                        class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="gra_from_date[]" type="number" min="1900" max="2099" step="1"
                        value="<?php echo (empty($mydata['from_date']) ? "2021": $mydata['from_date']  )?>"
                        class="form-control text-input mx-sm-1" />
                    <input name="gra_to_date[]" type="number" min="1900" max="2099" step="1"
                        value="<?php echo (empty($mydata['to_date']) ? "2021": $mydata['to_date']  )?>"
                        class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="gra_from_date[]" type="number" min="1900" max="2099" step="1" value=""
                        class="form-control text-input mx-sm-1" />
                    <input name="gra_to_date[]" type="number" min="1900" max="2099" step="1" value=""
                        class="form-control text-input mx-sm-1" />
