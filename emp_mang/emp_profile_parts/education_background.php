    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="ele_from_date" type="text" 
                    value="<?php echo $mydata['ele_from_date']?>"
                    class="form-control text-input mx-sm-1" />
                <input name="ele_to_date" type="text" 
                    value="<?php echo ($mydata['ele_to_date'])  ?>"
                    class="form-control text-input mx-sm-1" />
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="sec_from_date" type="text" 
                    value="<?php echo ($mydata['sec_from_date']) ?>"
                    class="form-control text-input mx-sm-1" />
                <input name="sec_to_date" type="text" 
                    value="<?php echo ($mydata['sec_to_date']) ?>"
                    class="form-control text-input mx-sm-1" />
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="d-flex flex-column">
            ...
            <div class="d-md-flex justify-content-center">
                ...
                <input name="voc_from_date" type="text" 
                    value="<?php echo ($mydata['voc_from_date']) ?>"
                    class="form-control text-input mx-sm-1" />
                <input name="voc_to_date" type="text" 
                    value="<?php echo ($mydata['voc_to_date']) ?>"
                    class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="coll_from_date[]" type="text" 
                        value="<?php echo ($mydata['from_date']) ?>"
                        class="form-control text-input mx-sm-1" />
                    <input name="coll_to_date[]" type="text" min="1900" max="2099" step="1"
                        value="<?php echo ($mydata['to_date']) ?>"
                        class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="coll_from_date[]" type="text"  value=""
                        class="form-control text-input mx-sm-1" />
                    <input name="coll_to_date[]" type="text"  value=""
                        class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="gra_from_date[]" type="text" 
                        value="<?php echo ($mydata['from_date']) ?>"
                        class="form-control text-input mx-sm-1" />
                    <input name="gra_to_date[]" type="text" 
                        value="<?php echo ($mydata['to_date']) ?>"
                        class="form-control text-input mx-sm-1" />
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="d-flex flex-column">
                ...
                <div class="d-md-flex justify-content-center">
                    ...
                    <input name="gra_from_date[]" type="text"  value=""
                        class="form-control text-input mx-sm-1" />
                    <input name="gra_to_date[]" type="text"  value=""
                        class="form-control text-input mx-sm-1" />
