...
$spreadsheet = $reader->load('../export_excel_parts/leave_summary.xlsx');

$spreadsheet->getActiveSheet()->setCellValue("B2", "LEAVE SUMMARY OF ".$year);
...
$fileName = "Leave-summary- " .$emp_id . $year . ".xlsx"; //date('d/m/Y')
